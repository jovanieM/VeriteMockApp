...
class PopUpDirectConnectTime: UIViewController, UITableViewDelegate, UITableViewDataSource {
  ...
  override func viewDidLoad() {
    ...
    directConnectTable.tableFooterView = UIView(frame: .zero)
    directConnectTable.tableHeaderView = UIView(frame: CGRect(x: 0, y: 0, width: directConnectTable.frame.width, height: 1.0))
  }
