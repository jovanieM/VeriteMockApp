//
//  AddressPrintQueueViewController.swift
//  KodakVer3
//
...
@available(iOS 9.0, *)
class AddressPrintQueueViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, AddressButtonCellDelegate{
    ...
    var printData = [AddressPrintData]()
    var buttonId = [Int]()
    ...
    var cell : AddressPrintQueueTableViewCell!
            ...
            if let ips = printJobs.indexPathsForVisibleRows{
                for i in 0..<ips.count{
                    if ips[i].row == 0{
                        ...
                        let cell = printJobs.cellForRow(at: ips[i]) as! AddressPrintQueueTableViewCell
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = Bundle.main.loadNibNamed("AddressPrintQueueTableViewCell", owner: self, options: nil)?.first as! AddressPrintQueueTableViewCell
    ...
    func buttonTapped(cell: AddressPrintQueueTableViewCell){
...
//            let NextViewController = self.storyboard?.instantiateViewController(withIdentifier: "AddressPrintHomeViewController") as? AddressPrintHomeViewController
