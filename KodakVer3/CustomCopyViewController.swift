...
class CustomCopyViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SettingViewDelegate {
    ...
    private let paperSizeKey2: String = "size2"
    private let colorOutKey2: String = "color2"
    private let typeKey2: String = "type2"
    private let qualityKey2: String = "quality2"
    
    
    var table:SettingsViewer!
    
    let defaultSize2 = UserDefaults.standard
    let defaultColor2 = UserDefaults.standard
    let defaultType2 = UserDefaults.standard
    let defaultQuality2 = UserDefaults.standard
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell2.selectedsetting.text = collections[indexPath.row][getSavedData2(receiver: indexPath.row)]
    ...
    func getSavedData2(receiver: Int) -> Int{
        
        switch receiver {
        case 1:
            return defaultSize2.integer(forKey: paperSizeKey2)
        case 2:
            return defaultColor2.integer(forKey: colorOutKey2)
        case 3:
            return defaultType2.integer(forKey: typeKey2)
        case 4:
            return defaultQuality2.integer(forKey: qualityKey2)
        default:
            return 0
        }
        
    }
    func setData2(value: Int, receiverIndex: Int){
        switch receiverIndex {
        case 1:
            defaultSize2.set(value, forKey: paperSizeKey2)
        case 2:
            defaultColor2.set(value, forKey: colorOutKey2)
        case 3:
            defaultType2.set(value, forKey: typeKey2)
        case 4:
            defaultQuality2.set(value, forKey: qualityKey2)
        default:
            break
        }
    }
    ...
    func sendData(index: Int, receiver: IndexPath) {
        ...
        setData2(value: index, receiverIndex: receiver.row)
        
        
        let cell = self.customTable.cellForRow(at: receiver) as! CustomCopySecondCell
        
        cell.selectedsetting.text = collections[receiver.row][getSavedData2(receiver: receiver.row)]
    }
